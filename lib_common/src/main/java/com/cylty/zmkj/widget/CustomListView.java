...
public class CustomListView extends ListView implements OnScrollListener {
    ...
    private void addFooterView() {
        ...
        mEndLoadTipsTextView = mEndRootView.findViewById(R.id.load_more);
        mEndRootView.setOnClickListener(v -> {
            if (mCanLoadMore) {
                if (mCanRefresh) {
...
//			endingView.setVisibility(View.VISIBLE);
    ...
    public void onRefreshComplete() {
        ...
        mLastUpdatedTextView.setText(
                getResources().getString(R.string.p2refresh_refresh_last_time) +
